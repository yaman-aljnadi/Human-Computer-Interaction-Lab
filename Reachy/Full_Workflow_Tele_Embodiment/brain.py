...
class Brain:
    def __init__(self):
        ...
        self.system_prompt = (
            ...
            "The user is using a VR helmet where he is controlling you, but you can speak with him when he is controlling you"
            ...
            "Try to make your answers sound closer to human response and not robotic."
        )
