...
class VisionTracker:
    ...
    def process_frame(self, frame, depth_frame=None):
        ...
        # Raw torso RGB view only for debugging.
        #
        # The OpenCV block-detection and sorting logic is intentionally commented
        # out instead of deleted so it can be restored later if needed.
        #
