...
# try:
#     while True:
#         s_pitch = reachy.l_arm.shoulder.pitch.present_position
#         s_roll  = reachy.l_arm.shoulder.roll.present_position
#         e_yaw   = reachy.l_arm.elbow.yaw.present_position
#         e_pitch = reachy.l_arm.elbow.pitch.present_position

#         print(f"{{ 'l_arm.shoulder.pitch': {s_pitch:.1f}, "
#               f"'l_arm.shoulder.roll': {s_roll:.1f}, "
#               f"'l_arm.elbow.yaw': {e_yaw:.1f}, "
#               f"'l_arm.elbow.pitch': {e_pitch:.1f} }}")
